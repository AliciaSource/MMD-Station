...
| `mmd-anim-physics-bullet` | Bullet Physics backend for MMD. This vendored copy builds Bullet 2.75 sources and integrates them with the runtime and PMX formats. |
